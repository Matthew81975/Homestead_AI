...
_FACTORS: dict[str, dict[str, float]] = {
    ...
    'density': {
        ...
        'pcf': 16.01846337396014, 'lb/ft3': 16.01846337396014, 'lb/ft^3': 16.01846337396014,
    },
    'pressure': {
        'Pa': 1.0, 'kPa': 1000.0, 'MPa': 1_000_000.0,
        'psf': 47.880281079000005, 'psi': 6894.757293168, 'ksi': 6_894_757.293168,
    },
}
